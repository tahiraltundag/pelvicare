  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex justify-center lg:justify-end lg:pt-10">
              <div className="relative w-full max-w-md flex flex-col gap-3">
                ...
                {/* Floating badges */}
                <div className="hero-badge-float absolute top-14 -right-24 bg-white rounded-xl px-3 py-2 shadow-lg">
      ...
      <section className="py-16" style={{ backgroundColor: '#1e3a5f' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-3">Pelvicare'in Temel Aldığı Yöntemlerin Etkinliğine Dair Çalışmalar</h2>
