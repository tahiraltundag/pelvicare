...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Trust Badges */}
      <section className="border-b border-gray-100 bg-[#f6f7f9]">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {cmsStats.map((stat, i) => (
              <AnimateInView key={stat.value} delay={i * 100}>
                <div className="text-center p-6 rounded-2xl bg-[#f6f7f9] h-full">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {cmsComparison.map((row, i) => (
                  <tr key={row.feature} className={i % 2 === 0 ? 'bg-[#f6f7f9]' : 'bg-white'}>
      ...
      {/* Newsletter */}
      <section className="py-12 bg-[#f6f7f9] border-t border-gray-100">
