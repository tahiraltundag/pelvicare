...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Trust Badges */}
      <section className="border-b border-gray-100 bg-gray-100">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {cmsStats.map((stat, i) => (
              <AnimateInView key={stat.value} delay={i * 100}>
                <div className="text-center p-6 rounded-2xl bg-gray-100 h-full">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {cmsComparison.map((row, i) => (
                  <tr key={row.feature} className={i % 2 === 0 ? 'bg-gray-100' : 'bg-white'}>
