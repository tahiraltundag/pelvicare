...
export default function HowItWorksPage() {
  ...
  const heroSubtitle = get('how_hero_subtitle', 'PelviQ, üç tedavi modalitesini tek bir giyilebilir cihazda birleştirerek klinik düzey pelvik taban rehabilitasyonunu evinize taşır.');
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">4 basit adımda klinik düzey rehabilitasyon.</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-2xl p-8 text-center" style={{ backgroundColor: '#f0fdfa' }}>
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: '#1e3a5f' }}>PelviQ Mobil App</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">Her modalite farklı mekanizma ile etki eder; birlikte kullanıldıklarında sinerjik etki sağlarlar.</p>
          </div>
