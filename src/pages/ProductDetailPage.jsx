...
const STATIC_PRODUCTS = {
  'pkg-starter': {
    ...
    description: 'PelvicAir ana cihaz ve 2 adet elektrod pad içeren başlangıç paketi. Mobil uygulama erişimi ve 1 yıl garanti dahildir.',
    images: ['/images/cihaz.png', '/images/urun-sistem-genel.jpg'],
    tags: ['EMS', 'Pelvik Taban', 'Başlangıç'],
    stock: 99, variants: [], category: null,
    features: ['PelvicAir Ana Cihaz', '2 Adet Elektrod Pad (10 seans)', 'Mobil Uygulama Erişimi', 'Türkçe Kullanım Kılavuzu', '1 Yıl Garanti'],
  },
  'pkg-premium': {
    id: 'pkg-premium', slug: 'pkg-premium',
    name: 'Premium Paket',
    price: 6490, comparePrice: 7990,
    description: 'PelvicAir ana cihaz, 4 elektrod pad, şarj ünitesi ve premium mobil uygulama erişimi içeren en popüler paket. 2 yıl garanti.',
    images: ['/images/cihaz.png', '/images/urun-sistem-genel.jpg'],
    tags: ['EMS', 'Pelvik Taban', 'Premium'],
    stock: 99, variants: [], category: null,
    features: ['PelvicAir Ana Cihaz', '4 Adet Elektrod Pad (20 seans)', 'Mobil Uygulama Erişimi (Premium)', 'Türkçe Kullanım Kılavuzu', '2 Yıl Garanti', 'Öncelikli Destek', 'Şarj Ünitesi'],
  },
  'pkg-pro': {
    ...
    stock: 99, variants: [], category: null,
    features: ['PelvicAir Ana Cihaz (x2)', '10 Adet Elektrod Pad (50 seans)', 'Klinisyen Yönetim Paneli', 'Hasta Takip Sistemi', 'Teknik Destek Hattı', '3 Yıl Garanti', 'Eğitim Materyalleri'],
  },
  'pad-5pack': {
